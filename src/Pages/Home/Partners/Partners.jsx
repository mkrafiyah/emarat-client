...
const Partners = () => {
    return (
        <div>
            <h2 className="text-5xl my-10 ml-20 font-bold">Our Partners</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
                <div>
                    <RiBuilding2Line className="text-5xl mx-auto"></RiBuilding2Line>
                    <div>
                    <h2 className="text-3xl">High-Rise</h2>
                ...
                <FaBuilding className="text-5xl mx-auto"></FaBuilding>
                    <div>
                    <h2 className="text-3xl">Mark & Co.</h2>
                    <p>Buildings</p>
                    </div>
                </div>
                <div>
                    ...
                    <div>
                    <h2 className="text-3xl">Real Estate Experts</h2>
                    <p>Real Estate Company</p>
                    </div>
                </div>
                <div>
                  <BiSolidBuildingHouse className="text-5xl mx-auto"></BiSolidBuildingHouse>
                    <div>
                    <h2 className="text-3xl">Home Design</h2>
                    <p>Real Estate Company</p>
                    </div>
                </div>
            </div>
